// eadrowser_local_sound.js
//
// this version ise used once you have downloaded the grammar sound database
//  the individual sounds are unpacked into the sound sub-directory
//   so we can play them as HTML5 audio directly from there

function playGr(ref1)
{

  var audio = new Audio('sound/' + ref1 + '.mp3');
  audio.play();
